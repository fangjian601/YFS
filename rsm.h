...
public:
	...
	void reg(int proc, S*, int(S::*meth)(const A1 a1, const A2 a2, const A3 a3,
			R &));
	...
	void reg(int proc, S*, int(S::*meth)(const A1 a1, const A2 a2, const A3 a3,
			const A4 a4, const A5 a5, R &));
};

template<class S, class A1, class R> void rsm::reg(int proc, S*sob,
...
template<class S, class A1, class A2, class R> void rsm::reg(int proc, S*sob,
...
template<class S, class A1, class A2, class A3, class R> void rsm::reg(
		int proc, S*sob, int(S::*meth)(const A1 a1, const A2 a2, const A3 a3,
				R & r)) {
	class h1: public handler {
	private:
		S * sob;
	...
	public:
		h1(S *xsob,
				int(S::*xmeth)(const A1 a1, const A2 a2, const A3 a3, R & r)) :
			sob(xsob), meth(xmeth) {
		}
		int fn(unmarshall &args, marshall &ret) {
			A1 a1;
...
template<class S, class A1, class A2, class A3, class A4, class R> void rsm::reg(
		int proc, S*sob, int(S::*meth)(const A1 a1, const A2 a2, const A3 a3,
				const A4 a4, R & r)) {
	class h1: public handler {
	private:
...
template<class S, class A1, class A2, class A3, class A4, class A5, class R> void rsm::reg(
		int proc, S*sob, int(S::*meth)(const A1 a1, const A2 a2, const A3 a3,
